      ...
      <Reveal delay={0.1}>
        <div className="space-y-6 text-stone-soft leading-relaxed">
          <p>
            ...
            everywhere. No occasion-only shoes that sit in a box, no synthetic
            uppers that crack within a year &mdash; just honest, full-grain
            leather footwear built for daily life.
          </p>

          <p>
            Every pair we make starts with carefully selected leather, finished
            and stitched by hand. We keep our range focused &mdash; a small
            collection of formal shoes, loafers, and sneakers &mdash; so that
            every style gets the attention it deserves rather than being one of
            hundreds.
          </p>
          ...
          <p>
            ...
            travelling, or just heading out for the day &mdash; these are shoes
            meant to keep up.
          </p>
        </div>
      </Reveal>
